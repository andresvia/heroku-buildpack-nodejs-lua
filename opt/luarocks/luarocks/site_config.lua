...
site_config.LUA_INCDIR=[[/usr/include]]
site_config.LUA_LIBDIR=[[/usr/lib]]
site_config.LUA_BINDIR=[[/usr/bin]]
site_config.LUAROCKS_SYSCONFDIR=[[/usr/local/etc/luarocks/config.lua]]
...
-- NOTE: bin/compile appends updated config variables, don't return here
